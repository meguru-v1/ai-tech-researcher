...
import type { Source, CollectedItem, SourcePerformance } from '@/types';
...
export function PerformanceTab({
  sourcesList, collectedItems, sourcePerformance, kwMatrix, isLoadingData,
}: PerformanceTabProps) {
  const stats = [
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card p-0 overflow-hidden">
        <h3 className="text-sm font-bold font-outfit px-6 pt-6 pb-4 flex items-center gap-2">
          <Zap size={16} className="text-amber-400" /> キーワード別パフォーマンス（収集数順）
        </h3>
